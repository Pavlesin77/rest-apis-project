...
def create_app(db_url=None):
    ...
    app.config["JWT_SECRET_KEY"] = "280697046564641635794158641525880081753"
    # JWTManager(app)
    jwt = JWTManager(app)
    ...
    def check_if_token_in_blocklist(_jwt_header, jwt_payload):
        ...
        # jti = jwt_payload["jti"]
        # result = RevokedTokenModel.query.filter_by(jti=jwt_payload["jti"]).first()
        # return result is not None
        # return db.session.query(RevokedTokenModel).filter_by(jti=jti).first() is not None
    ...
    #     print("Pokrećem db.create_all()...")
    #     db.create_all()
    #     print("Tabele su kreirane, ako nije bilo grešaka.")
...
# @app.route("/")
# def home():
#     return {"message": "Welcome to the Stores REST API!"}
